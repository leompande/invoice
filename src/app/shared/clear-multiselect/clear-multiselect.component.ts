...
@Component({
  selector: 'tulonge-clear-multiselect',
  templateUrl: './clear-multiselect.component.html',
  styleUrls: ['./clear-multiselect.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ClearMultiselectComponent implements OnInit {
